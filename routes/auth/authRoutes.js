...
router.post("/login", authenticateJWT, limiter.loginLimiter, authController.login);
...
router.get("/verifyemail", authenticateJWT, limiter.limiter, authController.verifyEmail);
